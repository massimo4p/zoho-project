        ...
        <div style={s.headMeta}>
          {lead?.owner && (
            <div>
              ...
              <div style={s.metaVal}>{lead.owner}</div>
            </div>
          )}
          {lead?.source && (
            <div>
              <div style={s.metaLbl}>Origine</div>
              <div style={s.metaVal}>{lead.source}</div>
            </div>
          )}
          <div>
            <div style={s.metaLbl}>CRM</div>
            <a href={contact.url} target="_blank" rel="noreferrer" style={s.metaLink}>Apri ↗</a>
          </div>
        </div>
