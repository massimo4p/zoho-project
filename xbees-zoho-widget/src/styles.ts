...
export const s: Record<string, React.CSSProperties> = {
  ...
  headCard:  { background: '#fff', border: '1px solid #E8E8EA', borderRadius: 14, padding: '22px 24px', display: 'flex', alignItems: 'center', gap: 20, width: '100%', boxSizing: 'border-box' as const, flexShrink: 0 },
  ...
  statGroup: { display: 'flex', flexDirection: 'column' as const, gap: 7, marginLeft: 40, flexShrink: 0 },
