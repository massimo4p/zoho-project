...
export const s: Record<string, React.CSSProperties> = {
  ...
  headCard:  { background: '#fff', border: '1px solid #E8E8EA', borderRadius: 14, padding: '38px 24px 32px', display: 'flex', alignItems: 'center', gap: 20, width: '100%', boxSizing: 'border-box' as const, flexShrink: 0 },
  ...
  statPill:  { padding: '4px 16px', borderRadius: 100, fontSize: 13, fontWeight: 700, minWidth: 104, textAlign: 'center' as const },
  ...
  avatarUnknown: { width: 60, height: 60, borderRadius: 16, background: '#F0F0F2', color: '#AAA', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 26, fontWeight: 700, flexShrink: 0 },
  typeToggle:{ display: 'flex', gap: 8, marginBottom: 14 },
  toggleOn:  { flex: 1, padding: '8px 0', borderRadius: 8, border: 'none', background: '#534AB7', color: '#fff', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
  toggleOff: { flex: 1, padding: '8px 0', borderRadius: 8, border: '1px solid #E8E8EA', background: '#fff', color: '#777', fontSize: 13, cursor: 'pointer' },
