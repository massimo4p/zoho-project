...
export const s: Record<string, React.CSSProperties> = {
  ...
  metricsRow:{ display: 'flex', alignItems: 'stretch', borderTop: '0.5px solid #E8E8EA', marginTop: 16, paddingTop: 14 },
  metric:    { flex: 1, textAlign: 'center' as const },
  metricLbl: { fontSize: 11, color: '#AAA', textTransform: 'uppercase' as const, letterSpacing: '0.05em', marginBottom: 4 },
  metricVal: { fontSize: 16, fontWeight: 700 },
  metricSep: { width: '0.5px', background: '#E8E8EA' },
  headColBlock: { display: 'flex', flexDirection: 'column' as const, width: '100%' },
