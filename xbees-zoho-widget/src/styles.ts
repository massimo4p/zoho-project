...
export const s: Record<string, React.CSSProperties> = {
  ...
  statCard:  { borderRadius: 10, padding: '8px 14px', textAlign: 'center' as const, minWidth: 82 },
  statLbl:   { fontSize: 11, textTransform: 'uppercase' as const, letterSpacing: '0.04em', marginBottom: 2, opacity: 0.85 },
